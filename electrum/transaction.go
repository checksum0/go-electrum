...
func (s *Client) BroadcastTransaction(rawTx string) (string, error) {
	resp := &basicResp{}
...
func (s *Client) GetTransaction(txHash string) (*GetTransactionResult, error) {
...
// https://electrumx.readthedocs.io/en/latest/protocol-methods.html#blockchain-transaction-get
func (s *Client) GetRawTransaction(txHash string) (string, error) {
	var resp basicResp
...
func (s *Client) GetMerkleProof(txHash string, height uint32) (*GetMerkleProofResult, error) {
...
func (s *Client) GetHashFromPosition(height, position uint32) (string, error) {
	var resp basicResp
...
// https://electrumx.readthedocs.io/en/latest/protocol-methods.html#blockchain-transaction-id-from-pos
func (s *Client) GetMerkleProofFromPosition(height, position uint32) (*GetMerkleProofFromPosResult, error) {
